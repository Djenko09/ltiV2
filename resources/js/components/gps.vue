...
<div class="">
    <div class="container">
      ...
      <button v-on:click="toggleHeatmap()">Toggle Heatmap</button>
      <button v-on:click="changeGradient()">Change gradient</button>
      <button v-on:click="changeRadius()">Change radius</button>
      <button v-on:click="changeOpacity()">Change opacity</button>
    </div>
    <div id="map"></div>
</div>
</div>
